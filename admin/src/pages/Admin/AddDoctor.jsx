            ...
            <div className='bg-white px-8 py-8 border rounded w-full max-w-4xl max-h-[80vh] overflow-y-scroll'>
                ...
                <div className='flex flex-col lg:flex-row items-start gap-10 text-gray-600'>
                    ...
                    <div className='w-full lg:flex-1 flex flex-col gap-4'>
                        ...
                        <div className='flex-1 flex flex-col gap-1'>
                            <p>Select the Localityy</p>
                            <select onChange={e => setSpeciality(e.target.value)} value={speciality} className='border rounded px-2 py-2'>
                                <option value="General physician">KPHB</option>
                                <option value="Gynecologist">Madhapur</option>
                                <option value="Dermatologist">Secunderabad</option>
                                <option value="Pediatricians">Uppal</option>
                                <option value="Neurologist">Chintal</option>
                                <option value="Gastroenterologist">Kokapet</option>
                            </select>
                        </div>
